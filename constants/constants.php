...
class constants {
    ...
    function getDmsContacts($dmsType) {
        switch ($dmsType) {
            case 1:
                return "<b>Мосиенко Ольга</b>\nВремя работы: с 9.00 до 18.00\nМоб. телефон: +7(905)706-22-71\nКруглосуточный пульт: +7(800)200-39-11";
            case 2:
    ...
    function getRegularVacationDurationText($restVacationData, $vacationType) {
        switch($vacationType) {
            case 0; case 1:
                ...
                return "Количество оставшихся дней $whichVacation отпуска в этом году: $restVacationDuration.\nВведите желаемую длительность отпуска, пример: <b>$restVacationDuration</b>";
            case 2; case 3:
                return "Введите желаемую длительность отпуска (количество дней).\nПример: <b>$restVacationDuration</b>";
        }
    }
