...
class constants {
    ...
    function getDateInThePastErrorText() {
        return "Дата находится в прошлом, либо не соотвествует условиям переноса. Дата, на которую переносится отпуск должна быть не менее 5 дней от текущей даты. Введите корректную дату";
    }
