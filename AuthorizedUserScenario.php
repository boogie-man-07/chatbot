    ...
    function run($text) {
        ...
        switch ($text) {
            ...
            case $this->commands['calendar']:
                ...
                $monthlyWorkDays = $this->calendarInfo->getMonthlyData();
                sendMessage($this->chatID, json_encode($monthlyWorkDays), null);
                //$this->salaryRoute->triggerCalendarAction($this->chatID, $monthlyWorkDays);
                exit;
